...
const myModule = angular.module('angular-dialog', []);

myModule.provider('$dialog', function() {
	let ctrl = this;
	...
	ctrl.$get = ['$compile', '$rootScope', function($compile, $rootScope) {
		...
		function createPopup(options) {
			...
			dialogModel = angular.extend(dialogModel, ctrl, options);
